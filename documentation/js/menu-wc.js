...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">crm-inetum-avril documentation</a>
                </li>
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="modules-links"' : 'id="xs-modules-links"' }>
                            ...
                            <li class="link">
                                <a href="modules/CoreModule.html" data-type="entity-link">CoreModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-CoreModule-22ccb2fe38ca5c48afa6199214f07b4b"' : 'data-target="#xs-components-links-module-CoreModule-22ccb2fe38ca5c48afa6199214f07b4b"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-CoreModule-22ccb2fe38ca5c48afa6199214f07b4b"' :
                                            'id="xs-components-links-module-CoreModule-22ccb2fe38ca5c48afa6199214f07b4b"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/IconsModule.html" data-type="entity-link">IconsModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-IconsModule-95e59d559e28aee4a485e1b29aea405a"' : 'data-target="#xs-components-links-module-IconsModule-95e59d559e28aee4a485e1b29aea405a"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-IconsModule-95e59d559e28aee4a485e1b29aea405a"' :
                                            'id="xs-components-links-module-IconsModule-95e59d559e28aee4a485e1b29aea405a"' }>
                                            <li class="link">
                            ...
                            <li class="link">
                                <a href="modules/OrdersModule.html" data-type="entity-link">OrdersModule</a>
                                    <li class="chapter inner">
                                        <div class="simple menu-toggler" data-toggle="collapse" ${ isNormalMode ?
                                            'data-target="#components-links-module-OrdersModule-5b7b32364dc7597b0d1791994c6007cb"' : 'data-target="#xs-components-links-module-OrdersModule-5b7b32364dc7597b0d1791994c6007cb"' }>
                                            <span class="icon ion-md-cog"></span>
                                            <span>Components</span>
                                            <span class="icon ion-ios-arrow-down"></span>
                                        </div>
                                        <ul class="links collapse" ${ isNormalMode ? 'id="components-links-module-OrdersModule-5b7b32364dc7597b0d1791994c6007cb"' :
                                            'id="xs-components-links-module-OrdersModule-5b7b32364dc7597b0d1791994c6007cb"' }>
                                            <li class="link">
